...
>
    ...
    <footer class="bg-caribe-950 text-sand-200">
        <div class="mx-auto max-w-7xl px-6 py-16 lg:px-10">
            ...
            <div class="mt-14 border-t border-sand-50/10 pt-8 text-xs leading-relaxed text-sand-200/50">
                <p>© {{ date('Y') }} Alux 33 · Desarrollado por Estratemex · Master broker: Grupo Dihouse. Todos los derechos reservados. · Aviso de Privacidad <span class="text-sand-200/30">· v1.0.4</span></p>
                <p class="mt-2">
    ...
    <div class="fixed right-3 top-1/2 z-40 flex -translate-y-1/2 flex-col items-center gap-2.5 sm:right-6 sm:gap-3">
        <a href="{{ $mapsUrl }}" target="_blank" rel="noopener" aria-label="Ver ubicación en Google Maps"
            class="flex h-10 w-10 items-center justify-center rounded-full bg-caribe-900 text-sand-50 shadow-lg shadow-ink/20 transition-transform duration-300 hover:scale-110 sm:h-12 sm:w-12">
