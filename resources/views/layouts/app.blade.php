    ...
    <footer class="bg-caribe-950 text-sand-200">
        <div class="mx-auto max-w-7xl px-6 py-16 lg:px-10">
            ...
            <div class="mt-14 border-t border-sand-50/10 pt-8 text-xs leading-relaxed text-sand-200/50">
                <p>© {{ date('Y') }} Alux 33 · Desarrollado por Estratemex · Master broker: Grupo Dihouse. Todos los derechos reservados. · Aviso de Privacidad <span class="text-sand-200/30">· v1.0.0</span></p>
                <p class="mt-2">
