...
<section id="contacto" class="bg-beige py-24 lg:py-32"
    ...
    <div class="mx-auto max-w-xl px-6 lg:px-10">
        <div class="reveal-group text-center">
            ...
            <p class="mx-auto mt-5 max-w-lg text-lg leading-relaxed text-ink-soft">Déjanos tus datos para recibir información sobre modelos, disponibilidad, precios, planes de pago, visitas o colaboración comercial.</p>
        </div>
        ...
        <form name="asesoria" method="POST" data-netlify="true" netlify-honeypot="bot-field" action="/gracias.html"
            ...
            <div x-show="step === 2" x-cloak class="space-y-4">
                ...
                <label class="flex items-start gap-3 pt-1 text-left text-[0.7rem] leading-relaxed text-ink-soft/80">
                    ...
                    <span>Acepto ser contactado por el equipo comercial de Alux 33 y Grupo Dihouse vía llamada, mensaje o correo electrónico y confirmo haber leído el Aviso de Privacidad.</span>
                </label>
